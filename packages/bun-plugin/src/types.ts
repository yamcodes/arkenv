 ...
 *
 * This type extracts the inferred type from the schema (result of `type()` from createEnv),
 ...
 *
 * @template TSchema - The environment variable schema (result of `type()` from createEnv)
 ...
 *
 * import type { ProcessEnvAugmented } from '@createEnv/bun-plugin';
