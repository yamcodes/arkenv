...
- #### Fix `nuxt` peer dependency range to support Nuxt 3 and Nuxt 4 _[`#1706`](https://github.com/yamcodes/arkenv/pull/1706) [`c4414ce`](https://github.com/yamcodes/arkenv/commit/c4414ce060407ecd22785adc217f80887621ff05) [@yamcodes](https://github.com/yamcodes)_

	
	Update the `peerDependencies` range for `nuxt` to `"^3.21.7 || ^4.0.0-0"` to support both Nuxt 3 (>=3.21.7) and Nuxt 4 development dependencies.
