...
describe("Nuxt config parser", () => {
	it("should reject nested layout extraction", () => {
		const content = `
	...
	it("should handle flat parser edge cases with comments and templates", () => {
		const content = `
			export const env = arkenv({
				...
				*/
				ADMIN_KEY: "string",
				NESTED_DESC: "host={localhost},port=5432",
