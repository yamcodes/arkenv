...
_(ArkEnv supports [ArkType](https://arktype.io/) notation natively. It also works with any other [Standard Schema](https://standardschema.dev/schema) validator such as Zod, Valibot, Typia, etc.)_
