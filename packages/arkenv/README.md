...
_ArkEnv supports [ArkType](https://arktype.io/) notation natively and works with any other [Standard Schema](https://standardschema.dev/schema) validator: Zod, Valibot, Typia, etc._
