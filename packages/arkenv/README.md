...
_ArkEnv supports [ArkType](https://arktype.io/) notation natively and works with any [Standard Schema](https://standardschema.dev/schema) validator like Zod, Valibot, and Typia._
