...
<Accordions>
  <Accordion title="Manual Setup">
    ...
    Create an `env.ts` file (typically in `src/` or at the root of your project) to define your schemas. Import `@arkenv/core` from the auto-generated `@/generated/env.gen.ts` helper file:
