...
⚠️ **Deprecated**: The Nested Layout is deprecated and will be removed in the next major release. Please use the new **[Flat Layout](/docs/nextjs/layouts/flat)** instead.
:::
