...
title: Simple layout
icon: Zap
description: The best Developer Experience way to use ArkEnv in your Next.js application, using a single schema file.
---
...
If exposing your server variable names, types, or constraints is a security concern, use the [strict layout](/docs/nextjs/strict-layout) instead.
:::
