...
[Vite guide](/docs/guides/frameworks/vite).
...
<Cards>
  <Card href="/docs/guides/frameworks/vite" title="Vite framework guide" description="Quickstart, transform mode, and reading env in application code." />
</Cards>
