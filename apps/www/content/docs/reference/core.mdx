...
`@arkenv/core` is the primary validation library. It exports `arkenv()` and an ArkType `type()` bound to ArkEnv keywords. No runtime dependencies; ArkType is a required peer.
