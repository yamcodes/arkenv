...
- **If you use ArkType**, use `@arkenv/core`. **You do not need `@arkenv/standard`**.
- **If you use Zod or Valibot**, use [`@arkenv/standard`](/docs/reference/standard). This keeps `arktype` out of the tree. **You do not need `@arkenv/core`**.
