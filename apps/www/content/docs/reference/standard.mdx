...
| Coercion                                | Built-in for ArkType shapes | Standard JSON Schema on the value, or `@arkenv/standard/valibot` / `/zod-mini` / [`toJsonSchema`](/docs/validating-your-environment/coercion-and-parsing#valibot-tojsonschema) |
...
<Cards>
  ...
  <Card href="/docs/validating-your-environment/coercion-and-parsing" title="Coercion" description="How ArkEnv turns env strings into typed outputs." />
