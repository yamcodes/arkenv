...
See [Reusing schemas](/docs/core-concepts/reusing-schemas).

## Standard Schema maps

With [`@arkenv/standard`](/docs/reference/standard), every value must be
a Standard Schema validator. ArkType DSL strings fail. Zod uses the root
import. Valibot uses `@arkenv/standard/valibot`.
