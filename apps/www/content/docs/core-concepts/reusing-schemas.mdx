...
from client code. See [client vs. server](/docs/core-concepts/client-vs-server#advanced-two-module-recipe).
...
<Cards>
  ...
  <Card href="/docs/core-concepts/hosting-presets" title="Hosting presets" description="Pre-populate provider environment variables for Vercel, Netlify, and Cloudflare." />
</Cards>
