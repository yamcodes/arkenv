...
[`toJsonSchema`](/docs/core-concepts/coercion#valibot-tojsonschema)
escape hatch.
...
<Cards>
  ...
  <Card href="/docs/validating-your-environment/defining-types" title="Defining types" description="Declare field types for either engine." />
