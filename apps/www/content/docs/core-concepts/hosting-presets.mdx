...
The short form is `-P`. Passing `none` scaffolds standard schema templates
without provider fields.
...
<Tabs items={["ArkType", "Zod", "Valibot"]}>
  ...
  <Tab value="Zod">
    ...
    export const env = arkenv({
    	...
    	// Add new or unlisted provider variables directly:
    	VERCEL_NEW_FEATURE: z.string().optional(),
    	VERCEL_ENV: z.enum(["production", "preview", "development"]).optional(),
    	VERCEL_URL: z.string().optional(),
    });
    ```
  ...
  <Tab value="Valibot">
    ...
    export const env = arkenv({
    	...
    	// Add new or unlisted provider variables directly:
    	VERCEL_NEW_FEATURE: v.optional(v.string()),
    	VERCEL_ENV: v.optional(v.picklist(["production", "preview", "development"])),
    	VERCEL_URL: v.optional(v.string()),
    });
    ```
...
<Tabs items={["ArkType", "Zod", "Valibot"]}>
  <Tab value="ArkType">
    ...
    export const env = arkenv({
    	...
    	VERCEL_URL: type("string?").pipe((url) =>
  ...
  <Tab value="Zod">
    ...
    export const env = arkenv({
    	...
    	// Stricter custom environment enum
    	VERCEL_ENV: z
    		.enum(["production", "preview", "development", "staging"])
    		.optional(),
    });
    ```
  </Tab>
  ...
  <Tab value="Valibot">
    ...
    export const env = arkenv({
    	...
    	VERCEL_URL: v.optional(
    		v.pipe(
    			v.string(),
    			v.transform((url) => `https://${url}`),
    		),
    	),

    	// Stricter custom environment enum
    	VERCEL_ENV: v.optional(
    		v.picklist(["production", "preview", "development", "staging"]),
    	),
    });
    ```
  </Tab>
