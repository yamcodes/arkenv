...
<Steps>
  ...
  <Step>
    ...
    > [!TIP]
    > **VS Code Users:** Want syntax highlighting for your ArkType schemas? Check out our [VS Code Integration guide](/docs/integrations/vscode) to learn about the ArkType extension and improve your DX!
  </Step>
