...
<Steps>
  ...
  <Step>
    ...
    > [!TIP]
    > **VS Code / Cursor / JetBrains IDEs Users:** Want syntax highlighting for your ArkType schemas? Check out our [VS Code / Cursor](/docs/integrations/vscode) / [JetBrains IDEs](/docs/integrations/jetbrains) integration guides to learn about the ArkType extension and improve your DX!
  </Step>
