...
<Steps>
  <Step>
    ...
    <Accordions>
      <Accordion title="Install alongside ArkType (recommended)">
        ArkEnv works best with **ArkType**, which provides the string DSL and built-in coercion.
  ...
  <Step>
    ...
    For this example, we'll use ArkType, but you can [use any other Standard Schema validator](/docs/arkenv/integrations/standard-schema) like Zod, Valibot, and Typia.
