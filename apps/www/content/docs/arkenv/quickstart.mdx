...
The easiest way to get started is with the [ArkEnv CLI](/docs/cli). It interactively configures your project, installs dependencies, and creates a ready-to-use schema.
...
<Accordions>
  <Accordion title="Manual Installation">
    <Steps>
      <Step>
        ### Install ArkEnv
        <Accordions defaultValue="Install ArkEnv + ArkType (recommended)">
...
Once your project is configured and your `env.ts` schema is created, just define some environment variables in a `.env` file in your project root:
...
<Cards>
  ...
  <Card 
    ...
    href="/docs/arkenv/integrations/ide/vscode"
