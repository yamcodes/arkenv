  ...
  <Accordion title="Manual Installation">
    <Steps>
      ...
      <Step>
        ...
        Enable `strict` mode for optimal typesafety, and use a [modern TypeScript module
        ...
        > You may omit `moduleResolution` if `module` is `"Preserve"`, `"Node16"`, or `"NodeNext"`. See
        > [Requirements](https://github.com/yamcodes/arkenv?tab=readme-ov-file#requirements) for details.
      </Step>
