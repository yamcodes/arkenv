...
ArkEnv introspects your schema to identify fields that should be numbers, booleans, and other non-string types you define. When you call `arkenv()`, it pre-processes your environment variables to perform these conversions *before* validation.
