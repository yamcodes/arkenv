...
² Dynamic coercion requires `coerce: true` and a Standard JSON Schema validator like [Zod](https://zod.dev) or [Valibot](https://valibot.dev) (see [Coercion](/docs/arkenv/coercion)).
