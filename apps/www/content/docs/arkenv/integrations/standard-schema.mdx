...
description: Mix ArkType with Zod, Valibot, or any Standard Schema validator — or switch to @arkenv/standard to drop ArkType.
---
...
```package-install
@arkenv/core arktype zod
```

:::tip
Want to avoid ArkType as a dependency altogether? Use [@arkenv/standard](/docs/arkenv/standard) instead — and for frameworks, the matching `/standard` subpath ([Next.js](/docs/nextjs/using-other-validators), [Nuxt](/docs/nuxt/using-other-validators)).
:::
