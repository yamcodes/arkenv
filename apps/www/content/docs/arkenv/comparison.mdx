...
| **Standard Schema** (Zod, Valibot, ArkType, etc.) | ✅ | Custom | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ |
| **TypeScript Support** | ✅ Full inference | Custom | ✅ Full inference | ✅ Full inference | ✅ Full inference | ✅ Full inference | ❌ None |
| **Runtime Validation** | ✅ | Custom | ✅ | ✅ | ✅ | ✅ | ✅ Basic |
| **Bundle Size (minzipped)** | &lt;2kB | 0 | ~5kB | ~13kB | ~3kB | ~1kB |
| **Auto Coercion** | ✅ Smart | Custom | ✅ Manual | ✅ Manual | ✅ Built-in | ❌ |
| **Default Values** | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ |
| **Client/Server Split** | ✅ Via plugins  | Custom | ✅ Built-in | ❌ | ❌ | ❌ |
| **Framework Integration** | Vite, Bun | Custom | Next.js focus | Agnostic | Agnostic | Agnostic |
| **Dependencies** | 1 (ArkType) | 0 | 1 (Zod) | 1 (Zod) | 0 | 1 (dotenv) |
| **Standard Schema** | ✅ | Custom | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ |
