...
- **No manual `runtimeEnv`**: In Next.js, T3 Env requires you to manually maintain a duplicate `runtimeEnv` block (e.g. `NEXT_PUBLIC_VAR: process.env.NEXT_PUBLIC_VAR`) so Next.js can inline variables. ArkEnv automatically scans your schema and generates these mappings for you.
