...
| **Bundle Size (minzipped)** | &lt;2kB | 0 | ~5kB | ~13kB | ~3kB | ~1kB | &lt;1kB |
| **Auto Coercion** | ✅ Smart | Custom | ✅ Manual | ✅ Manual | ✅ Built-in | ✅ | ❌ |
| **Default Values** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ |
| **Client/Server Split** | ✅ Via plugins | Custom | ✅ Built-in | ❌ | ❌ | ❌ | ❌ |
| **Framework Integration** | Vite, Bun | Custom | Next.js focus | Agnostic | Vite | Agnostic | Agnostic |
| **Dependencies** | 1 (ArkType) | 0 | 1 (Zod) | 1 (Zod) | 0 | 0 | 1 (dotenv) |
