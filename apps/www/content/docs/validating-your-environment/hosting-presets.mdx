...
You finished this section. Dig into
[API reference](/docs/reference) for options and packages, or
[core concepts](/docs/core-concepts) for coercion, transforms, and
Standard Schema.
