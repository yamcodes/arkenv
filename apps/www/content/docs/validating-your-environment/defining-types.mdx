...
See [Transforms](/docs/core-concepts/transforms) for morph vs Zod `.transform`, and [reusing schemas](/docs/validating-your-environment/reusing-schemas) when the whole schema should be shared.

## Next steps

If the app has a browser bundle, set [client vs. server boundaries](/docs/validating-your-environment/client-vs-server) next.
