...
[`arkenv init`](/docs/reference/init) and [hosting presets](/docs/validating-your-environment/hosting-presets) can inject the provider fields for you. You can still declare them by hand.
