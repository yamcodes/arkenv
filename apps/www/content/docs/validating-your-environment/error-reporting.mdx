...
Next.js, Nuxt, Vite, and Bun each enforce the boundary (runtime proxy and/or build transforms). See [client vs. server](/docs/validating-your-environment/client-vs-server).
