...
description: Choose between the ArkType core engine and the Standard Schema adapter.
---
...
Pick the engine that matches the schema library you write. Cookbooks:
[Validators](/docs/guides/validators).
...
[`toJsonSchema`](/docs/validating-your-environment/coercion-and-parsing#valibot-tojsonschema)
escape hatch.
...
| Zod Mini                                       | `@arkenv/standard/zod-mini` ([mixing](/docs/validating-your-environment/coercion-and-parsing#mixing-with-zod-mini)) |
...
<Cards>
  ...
  <Card href="/docs/validating-your-environment/defining-your-schema" title="Defining your schema" description="Declare field types for either engine." />
