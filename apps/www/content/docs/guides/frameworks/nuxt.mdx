...
Recipe for Nuxt. Overview: [Framework integration](/docs/validating-your-environment/framework-integration).
...
Use `@arkenv/nuxt/client` and `@arkenv/nuxt/server`. Shared/client schemas can auto-merge via Nuxt virtual aliases when you omit `extends`. See [Client vs. server](/docs/validating-your-environment/client-vs-server).
