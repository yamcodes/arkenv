...
`@arkenv/bun-plugin` is for Bun builds or fullstack servers that inline
public `BUN_PUBLIC_` keys. Plain Bun backends skip the plugin and call
`@arkenv/core` directly.
