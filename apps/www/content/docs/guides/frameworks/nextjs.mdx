...
Recipe for Next.js. Overview and stack comparison: [Framework integration](/docs/validating-your-environment/framework-integration).
...
Splits `env/client.ts`, `env/server.ts`, and `env/internal/shared.ts` so the server schema never enters the client module graph. See [Client vs. server](/docs/validating-your-environment/client-vs-server).
...
- [Hosting presets](/docs/validating-your-environment/hosting-presets) for Vercel system vars
