...
```package-install
npx arkenv init my-app --example with-vite-react --preset vercel
```
...
<Steps>
  ...
  <Step>
    ...
    The CLI asks about framework, validator, and hosting preset.
...
If you use Zod or Valibot, install
[`@arkenv/standard`](/docs/reference/standard) instead:
