...
<Cards>
  ...
  <Card href="/docs/core-concepts/coercion-and-parsing#valibot-tojsonschema" title="Coercion with Valibot" description="Advanced JSON Schema wiring and custom converters." />

  <Card href="/docs/frameworks" title="Framework guides" description="Integrate your Valibot schema with Next.js, Nuxt, Vite, or Bun." />
</Cards>
