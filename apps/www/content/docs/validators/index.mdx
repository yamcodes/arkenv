...
[options](/docs/reference/options) (`env`, `coerce`, `safe`, …) apply
...
<Cards>
  <Card href="/docs/validators/choosing-a-validator" title="Choosing a validator" description="Compare bundle size, syntax, and performance across engines." />
