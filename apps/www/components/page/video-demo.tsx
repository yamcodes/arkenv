...
export function VideoDemo() {
	...
	return (
		<div className="relative mb-4 w-full mx-auto">
			...
			<button
				type="button"
				className="relative rounded-lg overflow-hidden border border-fd-border bg-black/5 dark:bg-black/20 cursor-pointer m-0 p-0 w-full shadow-[0_0_20px_rgba(96,165,250,0.6)] dark:shadow-[0_0_100px_rgba(96,165,250,0.2)]"
