...
export function AnnouncementBadge() {
	return (
		<Link
			...
			className="group relative flex items-center gap-3 rounded-full border border-blue-500/20 bg-blue-500/5 px-3 py-1 text-sm font-medium text-blue-900 transition-all hover:bg-blue-500/10 dark:text-blue-200 lg:mb-6 mb-4 backdrop-blur-sm shadow-sm hover:shadow-md hover:border-blue-500/30"
		>
