	...
	return (
		<div className="flex flex-1 flex-col items-center justify-center relative w-full overflow-hidden">
			...
			<div className="flex flex-col lg:flex-row items-center justify-center px-4 sm:px-6 lg:pl-12 lg:pr-6 max-w-screen-2xl mx-auto w-full gap-8 lg:gap-20 lg:mt-20">
				<div className="flex flex-col items-center lg:items-start text-center lg:text-left flex-1 relative z-20 lg:mt-12 w-full max-w-full">
					<h1 className="mb-4 mt-16 lg:mt-0 w-full max-w-2xl">
						<div className="text-4xl sm:text-6xl font-semibold tracking-tighter xl:whitespace-nowrap">
							Better{" "}
