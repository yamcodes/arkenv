import { v as vueExports, s as serverRenderer_cjs_prodExports, u as useRouter, e as encodeRoutePath, r as resolveRouteObject, n as navigateTo, a as useNuxtApp, b as useRuntimeConfig, c as nuxtLinkDefaults } from './server.mjs';
...
import { _ as _export_sfc, u as useHead } from './_plugin-vue_export-helper-Cc2kLo-k.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${serverRenderer_cjs_prodExports.ssrRenderAttrs(vueExports.mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-69244417><div class="fixed left-0 right-0 spotlight z-10" data-v-69244417></div><div class="max-w-520px text-center z-20" data-v-69244417><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-69244417>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.status)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-69244417>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-69244417>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../../node_modules/.pnpm/nuxt@3.21.8_@biomejs+biome@2.4.14_@parcel+watcher@2.5.6_@types+node@24.12.2_@vercel+blo_016fad785d4abc896dc773157ab57ff3/node_modules/nuxt/dist/app/components/error-404.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-69244417"]]);

export { error404 as default };
//# sourceMappingURL=error-404-wzT0UWM8.mjs.map
