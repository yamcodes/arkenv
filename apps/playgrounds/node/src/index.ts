...
console.log(`COLOR:       ${env.COLOR} (${typeof env.COLOR})`);
console.log(`API_KEY:     ${env.API_KEY ?? "undefined"} (${typeof env.API_KEY})`);
console.log(`MY_ARRAY:    ${JSON.stringify(env.MY_ARRAY)} (isArray: ${Array.isArray(env.MY_ARRAY)})`);
console.log("-------------------------------------");
console.log("Note: UNRELATED was stripped because onUndeclaredKey is set to 'delete'.");
