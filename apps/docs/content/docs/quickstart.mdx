...
<Steps>
  ...
  <Step>
    ...
    ```
    This schema will be used to make your environment variables **validated** and **typesafe**.
  </Step>
  ...
  <Step>
    ...
    Import and use your typed environment variables anywhere in your code. As an example, you might have a `database.ts` file that looks like this:
