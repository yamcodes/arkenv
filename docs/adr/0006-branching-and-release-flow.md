# 0006. Branching and Release Flow
...
This architecture enforces synchronization at the Git/Infrastructure layer rather than the Application layer. Unreleased features physically cannot hit the production docs because they are quarantined in `dev`.
