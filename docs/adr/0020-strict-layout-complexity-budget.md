...
1. **Keep strict layout.** Its product promise is compile-time schema isolation. Flat/simple remains the default and the “feels like core `@arkenv/core`” path.
