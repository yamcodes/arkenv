 ...
 *
 * @param exampleNames Playground-synced example directory names
 */
 ...
 *
 * @param exampleNames Playground-synced example directory names
 * @param checkOnly When true, report drift instead of writing the file
 * @returns Whether the generated block differs from the file on disk
 * @throws When the Renovate config is missing the generated markers
 */
