...
- [ ] 2.2 Refactor `createEnv` overloads in `packages/arkenv/src/create-env.ts` to support Standard Schema inference.
- [ ] 2.3 Fix the return cast in the implementation of `createEnv` for `standard` mode.
...
- [ ] 3.2 Add a new test case in `packages/arkenv` specifically for type-level inference of standard mode.
