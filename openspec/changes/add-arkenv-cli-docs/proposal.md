...
### New Capabilities
- `cli-documentation`: Establishing comprehensive documentation for the `@arkenv/cli` and `create-arkenv` command, including README and online docs site pages.
