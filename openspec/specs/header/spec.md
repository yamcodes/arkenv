...
## Purpose
Defines the `Header` React component exported from `@arkenv/fumadocs-ui`. Covers the component's export availability, slot-based composition (logo, navigation links, actions), scroll-aware styling, and fixed viewport positioning.
