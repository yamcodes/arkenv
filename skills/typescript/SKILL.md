...
2. [Compiler Configuration](references/_sections.md#2-compiler-configuration-tscfg) — **CRITICAL**
...
3. [Async Patterns](references/_sections.md#3-async-patterns-async) — **HIGH**
...
4. [Module Organization](references/_sections.md#4-module-organization-module) — **HIGH**
...
6. [Memory Management](references/_sections.md#6-memory-management-mem) — **MEDIUM**
...
7. [Runtime Optimization](references/_sections.md#7-runtime-optimization-runtime) — **LOW-MEDIUM**
