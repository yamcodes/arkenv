...
Worked example of the *shape* (not the product decision): [`docs/to-json-schema-wiring.md`](../../docs/to-json-schema-wiring.md). Copy headings from [NOTE-TEMPLATE.md](NOTE-TEMPLATE.md).
