...
**Migration**: Ensure your environment and configuration meet these requirements before running `arkenv init`. If you need to bypass these checks for a specific reason, use the new `--force` (or `-f`) flag.
