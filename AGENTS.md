...
- Homepage `<title>` is punchy: "ArkEnv – Typesafe environment variables for TypeScript". Library names (ArkType, Zod, Valibot, Standard Schema) go in `<meta name="description">`, not the title.
