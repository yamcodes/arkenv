...
<br />
<p align="center">
  <a href="https://github.com/yamcodes/ark.env/actions/workflows/tests.yml">
    <img alt="CI Status" src="https://github.com/yamcodes/ark.env/actions/workflows/tests.yml/badge.svg?event=push&branch=main">
  </a>
