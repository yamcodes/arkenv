...
> While ArkEnv works with plain JavaScript, TypeScript is recommended for full type safety benefits. See [basic-js](https://github.com/yamcodes/arkenv/tree/main/examples/basic-js) for a JavaScript example.
...
| [`basic-js`](https://github.com/yamcodes/arkenv/tree/main/examples/basic-js)                     | Minimal example of *using ArkEnv with plain JavaScript* (no TypeScript). |
