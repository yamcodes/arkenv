...
| [with-nextjs-standard](https://github.com/yamcodes/arkenv/tree/main/examples/with-nextjs-standard)         | Example of *using ArkEnv with [@arkenv/nextjs/standard](https://arkenv.js.org/docs/nextjs) and [Zod](https://zod.dev/)*.           |
...
| [with-vite-react-standard](https://github.com/yamcodes/arkenv/tree/main/examples/with-vite-react-standard) | Example of *using ArkEnv with [@arkenv/vite-plugin/standard](https://arkenv.js.org/docs/vite-plugin) and [Zod](https://zod.dev/)*. |
