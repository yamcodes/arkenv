...
| [with-vite-react-zod](https://github.com/yamcodes/arkenv/tree/main/examples/with-vite-react-zod) | Example of *using ArkEnv with [@arkenv/vite-plugin/standard](https://arkenv.js.org/docs/vite-plugin) and [Zod](https://zod.dev/)*.              |
...
| [mix-and-match](https://github.com/yamcodes/arkenv/tree/main/examples/mix-and-match)             | Example of *mixing ArkType with Standard Schema validators like [Zod](https://zod.dev/) and [Valibot](https://valibot.dev/)* in `@arkenv/core`. |
