...
Reference: [https://nextjs.org/docs/app/getting-started/error-handling](https://nextjs.org/docs/app/getting-started/error-handling)
...
Reference: [https://nextjs.org/docs/app/api-reference/functions/redirect#behavior](https://nextjs.org/docs/app/api-reference/functions/redirect#behavior)
